...
public class StoreCardReward extends AbstractGoods{
    ...
    public StoreCardReward(int slot, int serviceDiscountIndex, int basePrice) {
    ...
    public void update(float rugY) {
        ...
        if (this.hb.hovered && !this.isPurchased) {
            ...
            TipHelper.renderGenericTip((float)InputHelper.mX, (float)InputHelper.mY - 70.0F * Settings.scale,
                    NewShopScreen.uiStrings.TEXT[12], NewShopScreen.uiStrings.TEXT[15]);
        } else {
            this.scale = 0.65F * Settings.scale;
        }
        ...
        if (this.hb.clicked || this.hb.hovered && CInputActionSet.select.isJustPressed()) {
            ...
            if (!Settings.isTouchScreen) {
                ...
                if (AbstractDungeon.player.gold < this.price) {
                    ...
                    SteamShopRoom.shopScreen.touchReward = true;
                }
            }
        }
    ...
    public void purchase() {
        ...
        if (AbstractDungeon.player.gold >= this.price) {
            ...
            AbstractDungeon.cardRewardScreen.open(AbstractDungeon.getRewardCards(),
                    new RewardItem(), NewShopScreen.uiStrings.TEXT[9]);
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(NewShopScreen.cardRewardServiceImg, bot_left_x, bot_left_y, width, height);
