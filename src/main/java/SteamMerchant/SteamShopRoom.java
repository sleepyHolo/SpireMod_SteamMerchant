...
public class SteamShopRoom extends AbstractRoom {
    private static final UIStrings uiStrings;
    public static final String[] TEXT;
    public int shopRarityBonus = 6;
    public SteamMerchant merchant;
    public static NewShopScreen shopScreen;

    public SteamShopRoom() {
    ...
    public void setMerchant(SteamMerchant merchant) {
    ...
    public void onPlayerEntry() {
        ...
        this.setMerchant(new SteamMerchant());
    }
